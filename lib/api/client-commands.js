...
module.exports = function(client) {
  return {
     ...
     *  Also save the filename in the results package - allowing screenshots to be read by reporters.
     *
     * ```
     *  this.demoTest = function (browser) {
    ...
    saveScreenshot : function(fileName, callback) {
      ...
      return this.screenshot(client.api.options.log_screenshot_data, function(result) {
        result.lastScreenshotFile = fileName;
        client.saveScreenshotToFile(path.resolve(fileName), result.value, function(err) {
          if (typeof callback === 'function') {
